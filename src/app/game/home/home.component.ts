...
export class HomeComponent implements OnInit {
  ...
  ngAfterViewInit() {
    // 设置背景音乐
    !this.Base.Music.bg_music.dom.paused &&
      Utils.FN.play_bg_music(
        this.Base.Music.bg_music.dom,
        "../../assets/media/home.mp3"
      );
  }
  ...
  public canvasclick(e) {
    // 设置背景音乐 移动端
    if (this.Base.Music.off) {
      Utils.FN.mobile_bg_music(
        this.Base.Music.bg_music.dom,
        "../../assets/media/home.mp3"
      );
      let array = this.Base.Music.game_music.doms;
